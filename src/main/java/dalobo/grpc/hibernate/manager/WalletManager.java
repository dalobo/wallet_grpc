package dalobo.grpc.hibernate.manager;
...
import dalobo.grpc.balance.BalanceResponse.Builder;
...
public class WalletManager {
	...
	/**
	 * Method used to save or update wallet when depositing
	 * 
	 * @param wallet
	 */
	...
	/**
	 * Get all wallets for the given userId. Method used when getting the balance
	 * 
	 * @param userId
	 * @return all wallets for the given userId
	 */
